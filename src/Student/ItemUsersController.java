...
import Administration.DeleteController;
import Administration.ModifyUserController;
...
//    }
    ...
    public void deleteBtnClick(){
        try {
            ...
            Administration.DeleteController controller = loader.<DeleteController>getController();
            controller.initData(user);
            stage.showAndWait();
            refreshParent();
        }
